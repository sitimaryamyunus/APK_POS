    ...
    <div class="container"> 
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent"> 
            <ul class="navbar-nav me-auto mb-2 mb-lg-0"> 
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('admin/users*') || Request::is('admin/users') ? 'active' : ''); ?>" href="<?php echo e(route('admin.users.index')); ?>">Users</a>
                </li>
                
                <!-- MENU BARU: Menyisipkan Jenis sebelum Produk dengan Indentasi Rapi -->
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::is('admin/jenis*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.jenis.index')); ?>">Jenis</a>
                </li>
                
                <li class="nav-item"> 
                    <a class="nav-link <?php echo e(Request::is('produk*') || Request::is('produk') ? 'active' : ''); ?>" href="<?php echo e(route('produk.index')); ?>">Produk</a> 
                </li>
                <li class="nav-item"> 
                    <a class="nav-link <?php echo e(Request::is('penjualan*') || Request::is('penjualan') ? 'active' : ''); ?>" href="<?php echo e(route('penjualan.index')); ?>">Penjualan</a> 
                </li>
            </ul> 
...
<?php /**PATH C:\laragon\www\APK_POSS\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>