...
<div class="container jenis-wrap py-4">
    <div class="jenis-section">
        ...
        <form action="<?php echo e(route('admin.jenis.index')); ?>" method="GET" class="mb-4">
            ...
            <table class="table align-middle text-center m-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-start fw-bold" style="color: #be185d;"><?php echo e(ucfirst($cat->name)); ?></td>
                    </tr>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\APK_POSS\resources\views/jenis/index.blade.php ENDPATH**/ ?>